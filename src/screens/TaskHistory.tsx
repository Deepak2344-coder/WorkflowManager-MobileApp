...
export default function TaskHistory() {
  ...
  const fetchHistory = async () => {
    ...
    const { data } = await supabase
      .from("tasks")
      .select("id, title, description, status, assigned_team_id, created_by, claimed_by, started_by, completed_at, deadline, remarks, created_at, teams(name), claimed_by_member:members!claimed_by(full_name), started_by_member:members!started_by(full_name), created_by_member:members!created_by(full_name)")
      .eq("status", "done")
